...
export function HelpButton({ onClick }: { onClick: () => void }) {
  return (
    <button
      onClick={onClick}
      className="flex items-center gap-1.5 px-3 py-2 rounded-xl border border-border/50 text-xs font-semibold text-primary/50 hover:text-primary hover:bg-surface hover:border-border transition-all"
    >
