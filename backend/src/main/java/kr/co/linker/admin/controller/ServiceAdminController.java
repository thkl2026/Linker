...
public class ServiceAdminController {
    ...
    @Operation(summary = "추천 멤버 포기 처리 — 삭제 없이 결과 보존")
    @PatchMapping("/projects/{id}/members/{memberId}/giveup")
    public ResponseEntity<Void> giveUpMember(@PathVariable UUID id, @PathVariable UUID memberId) {
        serviceAdminService.giveUpMember(id, memberId);
        return ResponseEntity.noContent().build();
    }
    ...
    @Operation(summary = "Gemini API 호출 테스트 (디버그용 - 권한 확인 필요)")
